...
<section class="post">
    ...
    <article role="article" id="post" class="post-content" itemprop="articleBody">
        <p>
          ...
          <a id="create" style="background-color: green; float: right; border: none;" href="javascript:history.back()" target="_blank">저장</a>
        </p>
...
<div id="grid" class="row flex-grid horizontal">
  <c:if test="${not empty pptList}">
    ...
    <article class="box-item shown" itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">
          <div id="addPpt" class="box-body">
        	  <input class="pptId" style="display:none" type="text" required="required" value="${ppt.pptId }"/>
        
              <div class="cover">
                  <a href="<c:url value="/ppt/pptCreateForm"/>">
                      <img src="<c:url value="/common/assets/img/add.png"/>" class="preload">
                  </a>
              </div>
              <div class="box-info">
                  ...
                  <a class="post-link" href="<c:url value="/ppt/pptCreateForm"/>">
                      <h2 class="post-title" itemprop="name">
                      	파일 추가하기
                      </h2>
                  </a>
