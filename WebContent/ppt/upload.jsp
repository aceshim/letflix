...
<div class="container" role="main">
	...
	<form id="uploadBox" method="post" action="<c:url value="/ppt/pptCreate"/>" enctype="multipart/form-data" novalidate="" class="box has-advanced-upload">
			...
			form.addEventListener( 'submit', function( e )
			{
				...
				if( isAdvancedUpload ) // ajax file upload for modern browsers
				{
					...
					ajax.onload = function()
					{
						...
						{
							form.classList.add( ajax.status==200 ? 'is-success' : 'is-error' );
							if(ajax.status == 200){
								$('#uploadBox').css("background", "url('http://localhost:8080/letflix/upload/"+ajax.responseText+"/01.JPG')")
