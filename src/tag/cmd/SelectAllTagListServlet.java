...
@WebServlet("/SelectAllTagListServlet")
public class SelectAllTagListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public SelectAllTagListServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 모든 리스트 출력
		try {
			ArrayList<TagEntity> tag = biz.selectAllTagList();
			...
			request.setAttribute("message", "모든 태그를 불러오는 도중 에러가 발생하였습니다.");
			rd.forward(request, response);
		}
	}
